...
BEGIN TRAN Transaction1
	   ...
	   SET @FinancialProductGroupId = (select financial_product_group_id from financial_product where name = 'Audi Perfect Lease Poziom 3 dla klientów prywatnych (36m)' and deleted = 0);
	   ...
	   SET @FinancialProduc24tId = (select id from financial_product where name = 'Audi Perfect Lease Poziom 3 dla klientów prywatnych (24m)' and deleted = 0);

	   SET @FinancialProduc36tId = (select id from financial_product where name = 'Audi Perfect Lease Poziom 3 dla klientów prywatnych (36m)' and deleted = 0);

	   SET @FinancialProduc48tId = (select id from financial_product where name = 'Audi Perfect Lease Poziom 3 dla klientów prywatnych (48m)' and deleted = 0);
