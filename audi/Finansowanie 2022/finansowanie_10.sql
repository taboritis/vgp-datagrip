...
BEGIN TRAN Transaction1
	   ...
	   SET @FinancialProductGroupId = (select financial_product_group_id from financial_product where name = 'Audi Perfect Lease Poziom 2e dla klientów prywatnych (36m)' and deleted = 0);
	   ...
	   SET @FinancialProduc24tId = (select id from financial_product where name = 'Audi Perfect Lease Poziom 2e dla klientów prywatnych (24m)' and deleted = 0);
	   UPDATE financial_product set rate = 2.54 where id = @FinancialProduc24tId;

	   SET @FinancialProduc36tId = (select id from financial_product where name = 'Audi Perfect Lease Poziom 2e dla klientów prywatnych (36m)' and deleted = 0);
	   UPDATE financial_product set rate = 4.26 where id = @FinancialProduc36tId;

	   SET @FinancialProduc48tId = (select id from financial_product where name = 'Audi Perfect Lease Poziom 2e dla klientów prywatnych (48m)' and deleted = 0);
	   UPDATE financial_product set rate = 4.97 where id = @FinancialProduc48tId;
